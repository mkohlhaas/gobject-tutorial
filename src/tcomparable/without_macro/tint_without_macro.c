...
static GParamSpec *int_properties[N_PROPERTIES] = {
  NULL,
};
...
static void t_int_init (TInt *self);
...
t_int_class_init (TIntClass *class)
{
  ...
  int_properties[PROP_INT]
      = g_param_spec_int ("value", "val", "Integer value", G_MININT, G_MAXINT, 0, G_PARAM_READWRITE);
